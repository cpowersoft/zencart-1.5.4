...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', '版权所有 &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. <a target="_blank" href="http://www.zen-cart.cn">Zen Cart</a> 模板由 <a target="_blank" href="http://www.pixemus.com/zen-cart-templates.html">pixemus</a> 提供');
